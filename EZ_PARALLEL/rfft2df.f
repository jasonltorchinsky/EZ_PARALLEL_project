!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! RFFT2DF. Returns the Fourier Transform (not normalized) of a 2D DOUBLE
! PRECISION matrix.
!
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE RFFT2DF_EZP(dim1_len, dim2_len, overlap, matrix)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
DO ii = 1, dim2_len
  CALL DFFTF(dim1_len, matrix(:,ii), WSAVE1) ! SW FFFT routine.
END DO
...
DO ii = 1, dim1_len
  CALL DFFTF(dim2_len, matrix_tr(:,ii), WSAVE2)
END DO
...
DO ii = 1, dim2_len_dim1_slice
  CALL DFFTF(dim1_len, dim1_slice(:,ii), WSAVE1) ! SW FFFT routine.
END DO
...
DO ii = 1, dim1_len_dim2_slice_list(proc_id + 1)
  CALL DFFTF(dim2_len_dim2_slice, dim2_slice_tr(:,ii), WSAVE2)
END DO
