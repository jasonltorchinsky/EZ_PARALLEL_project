!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! MINVAL. Returns the smallest value in a DOUBLE PRECISION matrix.
!
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE MINVAL_EZP(dim1_len, dim2_len, matrix, min_val)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
IF (proc_count .EQ. 1) THEN
  CALL SERIAL(dim1_len, dim2_len, matrix, min_val)
ELSE
  CALL PARALLEL(dim1_len, dim2_len, matrix, min_val)
END IF
...
!
! STRUCTURE: 1) Calculate the minimum value of the grid using the native
! MAXVAL function.
!
...
! stored (DOUBLE PRECISION).
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE SERIAL(dim1_len, dim2_len, matrix, min_val)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!
! STRUCTURE: 1) Calculate the minimum value of the sub-grid using the native
! MAXVAL function.
! 2) Take the minimum value of these sub-grid maximum values using
! MPI_ALLREDUCE.
!
! VARIABLES: - dim1_len, dim2_len: The shape of the sub-grid (INTEGER).
! - matrix: The array frim which we want the largest value (DOUBLE PRECISION,
! DIMENSION(dim1_len, dim2_len)).
! - min_val: The DOUBLE PRECISION variable in which the maximum value will be
! stored (DOUBLE PRECISION).
! - ierror: Integer for holding MPI error flag IDs (INTEGER).
! - proc_min_val: Maximum value of the sub-grid. (DOUBLE PRECISION).
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE PARALLEL(dim1_len, dim2_len, matrix, min_val)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
proc_min_val = MINVAL(matrix)

CALL MPI_ALLREDUCE(proc_min_val, min_val, 1, MPI_DOUBLE_PRECISION, &
