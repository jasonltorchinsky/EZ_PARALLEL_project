...
PRINT *, 'scaled_matrix shape: ', SHAPE(scaled_matrix)
PRINT *, 'wavenumber indices: ', scaled_dim1_neg_wavenum_low_index, &
& scaled_dim2_neg_wavenum_low_index
...
scl_dim1_len_dim1_slice = 3 * dim1_len_dim1_slice / 2
...
DO i = 1, proc_count
  IF ((i-1) .LT. MODULO(dim1_len, proc_count)) THEN
    dim1_len_dim2_slice_list(i) = 3 * (dim1_len_dim2_slice + 1) / 2
  ...
  ELSE
    dim1_len_dim2_slice_list(i) = 3 * dim1_len_dim2_slice / 2
  END IF
END DO
...
scl_dim1_len_dim1_slice = 3 * dim1_len_dim1_slice / 2
scl_dim2_len_dim1_slice = 3 * dim2_len_dim1_slice / 2


ALLOCATE(scl_dim1_slice(scl_dim1_len_dim1_slice,scl_dim2_len_dim1_slice))
! Calculate the new dim2_len_dim1_slice_list.
dim2_len_dim1_slice_list = 3 * dim2_len_dim1_slice_list / 2
