!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! CFFT2DB. Returns the inverse Fourier transform (normalized) of a 2D DOUBLE
! COMPLEX matrix.
!
...
! - matrix: The 2D DOUBLE COMPLEX array which will be inverse Fourier
! transformed (DOUBLE COMPLEX, DIMENSION(dim1_len, dim2_len)).
!
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE CFFT2DB_EZP(dim1_len, dim2_len, overlap, matrix)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
IF (proc_count .EQ. 1) THEN
  CALL SERIAL(dim1_len, dim2_len, overlap, matrix)
ELSE
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE SERIAL(dim1_len, dim2_len, overlap, matrix)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
DO ii = 1, dim2_len
  CALL ZFFTB(dim1_len, matrix(:,ii), WSAVE1) ! SW FFFT routine.
END DO
...
DO ii = 1, dim1_len
  CALL ZFFTB(dim2_len, matrix_tr(:,ii), WSAVE2)
END DO
...
DO ii = 1, dim2_len_dim1_slice
  CALL ZFFTB(dim1_len, dim1_slice(:,ii), WSAVE1) ! SW FFFT routine.
END DO
...
DO ii = 1, dim1_len_dim2_slice_list(proc_id + 1)
  ! SW FFFT routine.
  CALL ZFFTB(dim2_len_dim2_slice, dim2_slice_tr(:,ii), WSAVE2)
END DO
