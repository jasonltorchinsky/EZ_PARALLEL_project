...
WRITE(*,*) 'CFFT2DB unit test complete. Normal termination.'
...
! 2) FFT the test grid, IFFT the grid, and print it.
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE MAIN
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
WRITE(output_format,'(A,I0.8,A)') '(', 2*dim1_len, 'F16.8)'
...
! FFT the test grid.
CALL CFFT2DF_EZP(dim1_len, dim2_len, overlap, out_test_grid)
CALL CFFT2DB_EZP(dim1_len, dim2_len, overlap, out_test_grid)

! Each processor prints out its out_test_grid.
DO i = 0, proc_count-1
  IF (proc_id .EQ. i) THEN
