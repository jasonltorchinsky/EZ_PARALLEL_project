!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! SPECTRAL_DIM1_DERIVATIVE unit test.
!
...
WRITE(*,*) 'SPECTRAL_DIM1_DERIVATIVE unit test complete. ', &
& 'Normal termination.'
...
! 2) Obtain the spectral dimension 1 (dim1) derivative matrix, FFT the test
...
! Get spectral dim1 derivative matrix.
ALLOCATE(spec_dim1_deriv(dim1_len, dim2_len))
spec_dim1_deriv = (0.0_dp, 0.0_dp)
...
test_grid = spec_dim1_deriv * test_grid
...
DO j = 1, dim2_len
  DO i = 1, dim1_len
    ...
    ! Order 1 derivative - COS((dim1_ref + REAL(i-1_qb, dp) * dim1_spc) * pi_dp)
  END DO
END DO
! Each processor prints out its test_grid.
DO i = 0, proc_count-1
