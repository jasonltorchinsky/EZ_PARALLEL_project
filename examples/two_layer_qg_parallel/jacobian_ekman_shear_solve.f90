...
CALL CFFT2DB(scaled_grid_len, scaled_grid_len, 0, scaled_strmfunc_x_deriv(:,:,1))
CALL CFFT2DB(scaled_grid_len, scaled_grid_len, 0, scaled_strmfunc_x_deriv(:,:,2))
!~~
...
!~~ CHANGED FOR PARALLEL
CALL CFFT2DB(scaled_grid_len, scaled_grid_len, 0, scaled_strmfunc_y_deriv(:,:,1))
CALL CFFT2DB(scaled_grid_len, scaled_grid_len, 0, scaled_strmfunc_y_deriv(:,:,2))
!~~
...
!~~ CHANGED FOR PARALLEL
CALL CFFT2DB(scaled_grid_len, scaled_grid_len, 0, scaled_pot_vort_x_deriv(:,:,1))
CALL CFFT2DB(scaled_grid_len, scaled_grid_len, 0, scaled_pot_vort_x_deriv(:,:,2))
!~~
...
!~~ CHANGED FOR PARALLEL
CALL CFFT2DB(scaled_grid_len, scaled_grid_len, 0, scaled_pot_vort_y_deriv(:,:,1))
CALL CFFT2DB(scaled_grid_len, scaled_grid_len, 0, scaled_pot_vort_y_deriv(:,:,2))
!~~
...
!~~ CHANGED FOR PARALLEL
CALL CFFT2DF(scaled_grid_len, scaled_grid_len, 0, scaled_freq_jacobian(:,:,1))
CALL CFFT2DF(scaled_grid_len, scaled_grid_len, 0, scaled_freq_jacobian(:,:,2))
!~~
