\hypertarget{zero__padding__inv__dble__real_8f}{}\doxysection{C\+:/\+Users/\+Owner/\+Education and Research/\+Graduate School/\+Parallelization Module Project/\+E\+Z\+\_\+\+P\+A\+R\+A\+L\+L\+E\+L\+\_\+project/\+E\+Z\+\_\+\+P\+A\+R\+A\+L\+L\+E\+L/zero\+\_\+padding\+\_\+inv\+\_\+dble\+\_\+real.f File Reference}
\label{zero__padding__inv__dble__real_8f}\index{C:/Users/Owner/Education and Research/Graduate School/Parallelization Module Project/EZ\_PARALLEL\_project/EZ\_PARALLEL/zero\_padding\_inv\_dble\_real.f@{C:/Users/Owner/Education and Research/Graduate School/Parallelization Module Project/EZ\_PARALLEL\_project/EZ\_PARALLEL/zero\_padding\_inv\_dble\_real.f}}
\doxysubsection*{Functions/\+Subroutines}
\begin{DoxyCompactItemize}
\item 
subroutine \mbox{\hyperlink{zero__padding__inv__dble__real_8f_adddb0344ae526e2ba304e468442aa8ee}{zero\+\_\+padding\+\_\+inv\+\_\+dble\+\_\+real\+\_\+ezp}} (dim1\+\_\+len, dim2\+\_\+len, matrix, scl\+\_\+dim1\+\_\+len, scl\+\_\+dim2\+\_\+len, scaled\+\_\+matrix, overlap)
\item 
subroutine \mbox{\hyperlink{zero__padding__inv__dble__real_8f_ac5902f4bde2816aaf22d9c00893fabfa}{serial}} (dim1\+\_\+len, dim2\+\_\+len, matrix, scl\+\_\+dim1\+\_\+len, scl\+\_\+dim2\+\_\+len, scaled\+\_\+matrix)
\item 
subroutine \mbox{\hyperlink{zero__padding__inv__dble__real_8f_a87bee7799786670d74cbda4d6cacaa26}{parallel}} (dim1\+\_\+len, dim2\+\_\+len, matrix, scl\+\_\+dim1\+\_\+len, scl\+\_\+dim2\+\_\+len, scaled\+\_\+matrix, overlap, proc\+\_\+id, proc\+\_\+count)
\item 
subroutine \mbox{\hyperlink{zero__padding__inv__dble__real_8f_a54c16091719bbee018061181dcaaef63}{error\+\_\+handling}} (proc\+\_\+id)
\end{DoxyCompactItemize}


\doxysubsection{Function/\+Subroutine Documentation}
\mbox{\Hypertarget{zero__padding__inv__dble__real_8f_a54c16091719bbee018061181dcaaef63}\label{zero__padding__inv__dble__real_8f_a54c16091719bbee018061181dcaaef63}} 
\index{zero\_padding\_inv\_dble\_real.f@{zero\_padding\_inv\_dble\_real.f}!error\_handling@{error\_handling}}
\index{error\_handling@{error\_handling}!zero\_padding\_inv\_dble\_real.f@{zero\_padding\_inv\_dble\_real.f}}
\doxysubsubsection{\texorpdfstring{error\_handling()}{error\_handling()}}
{\footnotesize\ttfamily subroutine zero\+\_\+padding\+\_\+inv\+\_\+dble\+\_\+real\+\_\+ezp\+::error\+\_\+handling (\begin{DoxyParamCaption}\item[{integer}]{proc\+\_\+id }\end{DoxyParamCaption})}
...
\end{DoxyCode}
\mbox{\Hypertarget{zero__padding__inv__dble__real_8f_a87bee7799786670d74cbda4d6cacaa26}\label{zero__padding__inv__dble__real_8f_a87bee7799786670d74cbda4d6cacaa26}} 
\index{zero\_padding\_inv\_dble\_real.f@{zero\_padding\_inv\_dble\_real.f}!parallel@{parallel}}
\index{parallel@{parallel}!zero\_padding\_inv\_dble\_real.f@{zero\_padding\_inv\_dble\_real.f}}
\doxysubsubsection{\texorpdfstring{parallel()}{parallel()}}
{\footnotesize\ttfamily subroutine zero\+\_\+padding\+\_\+inv\+\_\+dble\+\_\+real\+\_\+ezp\+::parallel (\begin{DoxyParamCaption}\item[{integer}]{dim1\+\_\+len,  }\item[{integer}]{dim2\+\_\+len,  }\item[{double precision, dimension(\mbox{\hyperlink{cfft2df__unit__test__MATLAB_8m_acb4b6a591c5ad6fc207ef543dc74d1ae}{dim1\+\_\+len}},\mbox{\hyperlink{cfft2df__unit__test__MATLAB_8m_adef80e51b1bb5916dd9410de399f1319}{dim2\+\_\+len}})}]{matrix,  }\item[{integer}]{scl\+\_\+dim1\+\_\+len,  }\item[{integer}]{scl\+\_\+dim2\+\_\+len,  }\item[{double precision, dimension(scl\+\_\+dim1\+\_\+len, scl\+\_\+dim2\+\_\+len)}]{scaled\+\_\+matrix,  }\item[{integer}]{overlap,  }\item[{integer}]{proc\+\_\+id,  }\item[{integer}]{proc\+\_\+count }\end{DoxyParamCaption})}
...
\DoxyCodeLine{222 \textcolor{keywordtype}{DOUBLE PRECISION}, \textcolor{keywordtype}{DIMENSION(dim1\_len,dim2\_len)} :: matrix}
\DoxyCodeLine{223 \textcolor{keywordtype}{DOUBLE PRECISION}, \textcolor{keywordtype}{DIMENSION(:,:)}, \textcolor{keywordtype}{ALLOCATABLE} :: dim1\_slice, \&}
\DoxyCodeLine{224 \& dim2\_slice, \&}
\DoxyCodeLine{225 \& scl\_dim1\_slice, \&}
\DoxyCodeLine{226 \& scl\_dim2\_slice}
\DoxyCodeLine{227 \textcolor{keywordtype}{DOUBLE PRECISION}, \textcolor{keywordtype}{DIMENSION(scl\_dim1\_len, scl\_dim2\_len)} :: scaled\_matrix}
\DoxyCodeLine{228 }
...
\DoxyCodeLine{320     \& * dim2\_len\_dim1\_slice\_list(fill\_in\_proc\_trgt+1), mpi\_double\_precision, \&}
...
\DoxyCodeLine{326     \& * dim2\_len\_dim1\_slice\_list(proc\_id+1), mpi\_double\_precision, \&}
...
\DoxyCodeLine{340     \& * dim2\_len\_dim1\_slice\_list(fill\_in\_proc\_trgt+1), mpi\_double\_precision, \&}
...
\DoxyCodeLine{434     \& * dim2\_len\_dim1\_slice\_list(proc\_id+1), mpi\_double\_precision, \&}
...
\DoxyCodeLine{440     \& * dim2\_len\_dim1\_slice\_list(fill\_in\_proc\_trgt+1), mpi\_double\_precision, \&}
...
\DoxyCodeLine{448     \& * dim2\_len\_dim1\_slice\_list(fill\_in\_proc\_trgt+1), mpi\_double\_precision, \&}
...
\DoxyCodeLine{454     \& * dim2\_len\_dim1\_slice\_list(proc\_id+1), mpi\_double\_precision, \&}
...
\DoxyCodeLine{480 }
\DoxyCodeLine{481 }
\DoxyCodeLine{482 \textcolor{keyword}{CALL }\mbox{\hyperlink{share__subgrid__boundaries__dble__real_8f_a5170f5c15842e65d901113fc48dfe97a}{share\_subgrid\_boundaries\_dble\_real\_ezp}}(dim1\_len, dim2\_len, overlap, matrix)}
\DoxyCodeLine{483 }

\end{DoxyCode}
\mbox{\Hypertarget{zero__padding__inv__dble__real_8f_ac5902f4bde2816aaf22d9c00893fabfa}\label{zero__padding__inv__dble__real_8f_ac5902f4bde2816aaf22d9c00893fabfa}} 
\index{zero\_padding\_inv\_dble\_real.f@{zero\_padding\_inv\_dble\_real.f}!serial@{serial}}
\index{serial@{serial}!zero\_padding\_inv\_dble\_real.f@{zero\_padding\_inv\_dble\_real.f}}
\doxysubsubsection{\texorpdfstring{serial()}{serial()}}
{\footnotesize\ttfamily subroutine zero\+\_\+padding\+\_\+inv\+\_\+dble\+\_\+real\+\_\+ezp\+::serial (\begin{DoxyParamCaption}\item[{integer}]{dim1\+\_\+len,  }\item[{integer}]{dim2\+\_\+len,  }\item[{double precision, dimension(\mbox{\hyperlink{cfft2df__unit__test__MATLAB_8m_acb4b6a591c5ad6fc207ef543dc74d1ae}{dim1\+\_\+len}}, \mbox{\hyperlink{cfft2df__unit__test__MATLAB_8m_adef80e51b1bb5916dd9410de399f1319}{dim2\+\_\+len}})}]{matrix,  }\item[{integer}]{scl\+\_\+dim1\+\_\+len,  }\item[{integer}]{scl\+\_\+dim2\+\_\+len,  }\item[{double precision, dimension(scl\+\_\+dim1\+\_\+len, scl\+\_\+dim2\+\_\+len)}]{scaled\+\_\+matrix }\end{DoxyParamCaption})}
...
\end{DoxyCode}
\mbox{\Hypertarget{zero__padding__inv__dble__real_8f_adddb0344ae526e2ba304e468442aa8ee}\label{zero__padding__inv__dble__real_8f_adddb0344ae526e2ba304e468442aa8ee}} 
\index{zero\_padding\_inv\_dble\_real.f@{zero\_padding\_inv\_dble\_real.f}!zero\_padding\_inv\_dble\_real\_ezp@{zero\_padding\_inv\_dble\_real\_ezp}}
\index{zero\_padding\_inv\_dble\_real\_ezp@{zero\_padding\_inv\_dble\_real\_ezp}!zero\_padding\_inv\_dble\_real.f@{zero\_padding\_inv\_dble\_real.f}}
\doxysubsubsection{\texorpdfstring{zero\_padding\_inv\_dble\_real\_ezp()}{zero\_padding\_inv\_dble\_real\_ezp()}}
{\footnotesize\ttfamily subroutine zero\+\_\+padding\+\_\+inv\+\_\+dble\+\_\+real\+\_\+ezp (\begin{DoxyParamCaption}\item[{integer}]{dim1\+\_\+len,  }\item[{integer}]{dim2\+\_\+len,  }\item[{double precision, dimension(\mbox{\hyperlink{cfft2df__unit__test__MATLAB_8m_acb4b6a591c5ad6fc207ef543dc74d1ae}{dim1\+\_\+len}}, \mbox{\hyperlink{cfft2df__unit__test__MATLAB_8m_adef80e51b1bb5916dd9410de399f1319}{dim2\+\_\+len}})}]{matrix,  }\item[{integer}]{scl\+\_\+dim1\+\_\+len,  }\item[{integer}]{scl\+\_\+dim2\+\_\+len,  }\item[{double precision, dimension(scl\+\_\+dim1\+\_\+len, scl\+\_\+dim2\+\_\+len)}]{scaled\+\_\+matrix,  }\item[{integer}]{overlap }\end{DoxyParamCaption})}
...
\DoxyCodeLine{140 \textcolor{comment}{! -\/ matrix: The matrix to be scaled (DOUBLE PRECISION,}}
...
\DoxyCodeLine{143 \textcolor{comment}{! -\/ scaled\_matrix: The resulting scaled matrix (DOUBLE PRECISION,}}
...
\DoxyCodeLine{176 \textcolor{comment}{! length matches that of the global grid) (DOUBLE PRECISION, DIMENSION(:,:),}}
